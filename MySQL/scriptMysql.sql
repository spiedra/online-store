...
(
	...
	,ID_CATEGORY INT 
    ,CONSTRAINT FK_USER_CATEGORY FOREIGN KEY (ID_CATEGORY) REFERENCES B97452_PROYECTO2_IF4101.tb_CATEGORY (ID)
);
...
BEGIN
	...
	ELSE 
		...
		INSERT INTO b97452_proyecto2_if4101.sp_REGISTER_PRODUCT(NAME, PRICE, DESCRIPTION, ID_CATEGORY)
        VALUES(param_NAME, param_PRICE, param_DESCRIPTION, local_CATEGORY_ID);
        SELECT 1 INTO out_RETURN;
	END IF;
END;