...
INSERT INTO b97452_proyecto2_if4101.tb_users(USER_NAME, PASSWORD, ID_ROLE)VALUES('admin', 'admin', 1);
...
BEGIN
	...
	IF EXISTS (SELECT NAME FROM B97452_PROYECTO2_IF4101.tb_PRODUCTS WHERE NAME = param_NAME AND IS_DELETED = 0) THEN
		SELECT 0 INTO out_RETURN;
	ELSE 
...
BEGIN
		...
		WHERE (PP.IS_ACTIVE IS NULL OR PP.IS_ACTIVE = 0) AND PR.IS_DELETED = 0
		...
		LEFT JOIN b97452_proyecto2_if4101.tb_PRODUCTS_PROMOTION PP
			...
			LEFT JOIN b97452_proyecto2_if4101.tb_promotion PRM
				...
				JOIN b97452_proyecto2_if4101.tb_category CT
					...
					JOIN b97452_proyecto2_if4101.tb_image IM
							ON PR.ID_IMAGE = IM.ID
	WHERE PR.NAME LIKE CONCAT('%', param_PRODUCT_NAME , '%') AND CT.TYPE = param_CATEGORY_TYPE AND PR.IS_DELETED = 0
	ORDER BY PR.ID ASC;
END;
		...
		LEFT JOIN b97452_proyecto2_if4101.tb_PRODUCTS_PROMOTION PP
			...
			LEFT JOIN b97452_proyecto2_if4101.tb_promotion PRM
				...
				JOIN b97452_proyecto2_if4101.tb_category CT
					...
					JOIN b97452_proyecto2_if4101.tb_image IM
							ON PR.ID_IMAGE = IM.ID
	WHERE (PP.ID_PRODUCT IS NULL OR PP.ID_PROMOTION IS NULL OR PP.IS_ACTIVE = 0) AND PR.IS_DELETED = 0
				...
				ON PR.ID = PP.ID_PRODUCT
					JOIN b97452_proyecto2_if4101.tb_promotion PRM
                        ...
                        JOIN b97452_proyecto2_if4101.tb_category CT
                            ...
                            JOIN b97452_proyecto2_if4101.tb_image IM
								ON PR.ID_IMAGE = IM.ID
		WHERE NOW() <= PRM.END_DATE AND PR.IS_DELETED = 0;
END
...
INSERT INTO B97452_PROYECTO2_IF4101.tb_IMAGE(IMAGE_NAME)VALUES('suavitel.png');
INSERT INTO B97452_PROYECTO2_IF4101.tb_IMAGE(IMAGE_NAME)VALUES('clorox.png');
INSERT INTO B97452_PROYECTO2_IF4101.tb_category(TYPE)VALUES('Cleaning products');

INSERT INTO B97452_PROYECTO2_IF4101.tb_PRODUCTS(NAME, PRICE, DESCRIPTION, ID_CATEGORY, ID_IMAGE)
VALUES('Suavitel', 7.0, 'Smell of flowers', 1, 1);
INSERT INTO B97452_PROYECTO2_IF4101.tb_PRODUCTS(NAME, PRICE, DESCRIPTION, ID_CATEGORY, ID_IMAGE)
VALUES('Clorox', 7.0, 'Powerful', 1, 2);
