...
CREATE TABLE b97452_proyecto2_if4101.tb_USER_DATA
(
...
(
    ...
    ,ID_USER_DATA INT NULL
    ,CONSTRAINT FK_USER_ROLE FOREIGN KEY (ID_ROLE) REFERENCES B97452_PROYECTO2_IF4101.tb_ROLE (ID)
    ,CONSTRAINT FK_USER_DATA FOREIGN KEY (ID_USER_DATA) REFERENCES B97452_PROYECTO2_IF4101.tb_USER_DATA (ID)
);
...
IN param_ADRESS     VARCHAR(58),
OUT out_RETURN    INT)
BEGIN 
	IF EXISTS (SELECT USER_NAME FROM b97452_proyecto2_if4101.tb_users WHERE USER_NAME = param_USER_NAME AND PASSWORD = param_PASSWORD) THEN
		SELECT 0 INTO out_RETURN;
	ELSE 
		INSERT INTO b97452_proyecto2_if4101.tb_USER_DATA(DATE_BIRTH, ADDRESS)
        VALUES(param_DATA_BIRTH, param_ADRESS);
    
		INSERT INTO b97452_proyecto2_if4101.tb_users(USER_NAME, PASSWORD, ID_ROLE)
        VALUES(param_USER_NAME, param_PASSWORD, 2);
        SELECT 1 INTO out_RETURN;
	END IF;
END;
